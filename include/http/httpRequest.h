...
public:
    ...
    HttpRequest(std::shared_ptr<MySQLConnectionPool> mysql, std::shared_ptr<RedisConnectionPool> redis);
    ~HttpRequest() = default;
...
private:
    ...
    std::shared_ptr<MySQLConnectionPool> m_mysql;
    std::shared_ptr<RedisConnectionPool> m_redis;
